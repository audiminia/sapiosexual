...
from sapiosexual.__main__ import STATS, USER_INFO, GDPR
from sapiosexual.modules.disable import DisableAbleCommandHandler
from sapiosexual.modules.helper_funcs.extraction import extract_user, get_user
...
from sapiosexual import client, SUDO_USERS
...
def gdpr(update, context):
    ...
    update.effective_message.reply_text(
        ...
        "you from any chats, as that is telegram data, not sapiosexual data. "
...
def src(update, context):
    update.effective_message.reply_text(
        "Hey there! You can find what makes me click [here](www.github.com/amTanny/sapiosexualbot).",
        parse_mode=ParseMode.MARKDOWN,
...
def stats(update, context):
    stats = "<b>Current sapiosexual stats:</b>\n" + "\n".join([mod.__stats__() for mod in STATS])
