...
from sapiosexual.modules.sql.redis import start_afk, end_afk, is_user_afk, afk_reason
from sapiosexual import REDIS
from sapiosexual.modules.users import get_user_id
