...
import sapiosexual.modules.sql.notes_sql as sql
from sapiosexual import dispatcher, LOGGER, OWNER_ID, MESSAGE_DUMP
from sapiosexual.__main__ import DATA_IMPORT
from sapiosexual.modules.helper_funcs.chat_status import user_admin
from sapiosexual.modules.helper_funcs.alternate import typing_action

# from sapiosexual.modules.rules import get_rules
import sapiosexual.modules.sql.rules_sql as rulessql

# from sapiosexual.modules.sql import warns_sql as warnssql
import sapiosexual.modules.sql.blacklist_sql as blacklistsql
from sapiosexual.modules.sql import disable_sql as disabledsql

# from sapiosexual.modules.sql import cust_filters_sql as filtersql
# import sapiosexual.modules.sql.welcome_sql as welcsql
import sapiosexual.modules.sql.locks_sql as locksql
from sapiosexual.modules.connection import connected
...
def export_data(update, context):
    ...
    f = open("sapiosexual{}.backup".format(chat_id), "w")
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("sapiosexual{}.backup".format(chat_id), "rb"),
        caption="*Successfully imported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `sapiosexual-Backup` is specially made for notes.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("sapiosexual{}.backup".format(chat_id))  # Cleaning file
